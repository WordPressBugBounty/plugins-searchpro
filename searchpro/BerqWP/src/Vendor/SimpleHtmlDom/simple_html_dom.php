<?php
namespace BerqWP\Vendor\SimpleHtmlDom;
/**
...
class simple_html_dom
{
	...
	{
		return @berqwp_str_get_html("<$name>$value</$name>")->firstChild();
	}

	function createTextNode($value)
	{
		return @end(berqwp_str_get_html($value)->nodes);
	}
