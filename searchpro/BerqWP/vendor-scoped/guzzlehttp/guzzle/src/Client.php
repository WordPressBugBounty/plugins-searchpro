...
use BerqWP\GuzzleHttp\Cookie\CookieJar;
use BerqWP\GuzzleHttp\Exception\GuzzleException;
use BerqWP\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \BerqWP\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
