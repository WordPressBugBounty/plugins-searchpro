...
namespace BerqWP\GuzzleHttp\Exception;

use BerqWP\GuzzleHttp\BodySummarizer;
use BerqWP\GuzzleHttp\BodySummarizerInterface;
use BerqWP\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $previous = null, array $handlerContext = [], ?BodySummarizerInterface $bodySummarizer = null) : self
    {
        ...
        $uri = \BerqWP\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
