...
use BerqWP\GuzzleHttp\Cookie\CookieJarInterface;
...
use BerqWP\Psr\Log\LoggerInterface;
/**
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('BerqWP\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
